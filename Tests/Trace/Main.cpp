...
int Test_01(int i_iArgC, char* i_pArgV[])
{
    ...
    for (tUINT32 l_dwI = 0; l_dwI < l_dwCount; l_dwI++)
    {
        ...
        l_pClient = P7_Create_Client(TM("/P7.Sink=Baical /P7.Addr=192.168.81.1"));
...
int Test_04(int i_iArgC, char* i_pArgV[])
{
    ...
    l_pClient = P7_Create_Client(TM("/P7.Sink=Baical /P7.Addr=192.168.81.1 /P7.PSize=1472 /P7.Pool=32768"));
    if (NULL == l_pClient)
    {
        printf("Error: P7 engine was not initialized. Exit\n");
        goto l_lExit;
